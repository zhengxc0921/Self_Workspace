...
class Config:
    def __init__(self,project):
        ...
        self.USE_MIL_Data=False
        #当前路径由train.py决定
        config_dir = r'I:/MIL_AI/Python/yolov4-tiny-pytorch/'
        self.anchors_path = config_dir+'model_data/yolo_anchors.txt'
        self.model_path = config_dir+r'model_data/yolov4_tiny_weights_{}.pth'.format(project)
        self.pt_model_dst =config_dir+ r'model_data/yolov4_tiny_weights_{}.pt'.format(project)
        self.onnx_model_dst =config_dir+ r'model_data/yolov4_tiny_weights_{}.onnx'.format(project)
        ...
        print("calc_device: ",self.calc_device)
